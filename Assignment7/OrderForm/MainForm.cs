...
namespace OrderForm
{
    public partial class MainForm : Form
    {
        ...
        {
            Order order = new Order("1", new Customer("张三"), new List<OrderDetail>());
            order.AddItem(new OrderDetail(1, new Goods("apple", 100.0), 10));
            order.AddItem(new OrderDetail(2, new Goods("banana", 50.0), 61));
            orderService.AddOrder(order);
            Order order2 = new Order("2", new Customer("李四"), new List<OrderDetail>());
            order2.AddItem(new OrderDetail(1, new Goods("banana", 200.0), 10));
